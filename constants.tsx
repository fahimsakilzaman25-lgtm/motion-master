...
export const PHYSICS_EQUATIONS = [
  { formula: 'v = u + at', description: 'Velocity-Time Relation' },
  { formula: 's = ut + ½at²', description: 'Position-Time Relation' },
  { formula: 'v² = u² + 2as', description: 'Velocity-Position Relation' },
];
...
export const AppLogo: React.FC<{ className?: string }> = ({ className = "w-12 h-12" }) => (
  <div className={`${className} relative group`}>
    ...
    <img 
      src="logo.png" 
      alt="MotionMaster Logo" 
      className="relative z-10 w-full h-full object-cover rounded-xl shadow-lg border border-white/10"
      onError={(e) => {
        // Fallback to the rocket if image is missing
        (e.target as HTMLImageElement).src = 'https://raw.githubusercontent.com/lucide-icons/lucide/main/icons/rocket.svg';
      }}
    />
  </div>
);
...
export const ICONS = {
  ...
  VolumeMute: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="22" x2="16" y1="9" y2="15"/><line x1="16" x2="22" y1="9" y2="15"/></svg>
  )
};
